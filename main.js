...
form.addEventListener("submit", (e) => {
  ...
  if (!title || !link || dSplit.length < 3) return;
  ...
  replays.forEach((r) => {
    ...
    card.innerHTML = `
      <div class="border-r-2 pr-4 replay-content">
        ...
        <p>Replay   : <a href="${r.link}" target="_blank">Klik here</a></p>
      </div>
...
function generateCSV() {
  ...
  const headers = ["Matkul", "Tanggal", "Materi", "Session", "Replay"];
